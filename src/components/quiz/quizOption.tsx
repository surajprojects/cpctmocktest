...
export default function QuizOption({
    ...
    return (
        <>
            <div className={clsx("group border-2 p-4 rounded-lg shadow-xs flex items-center transition duration-300 ease-in-out", isSelected ? "border-blue-600 bg-blue-50/50" : "border-gray-200 hover:border-blue-600 bg-white hover:bg-blue-50/50")}>
